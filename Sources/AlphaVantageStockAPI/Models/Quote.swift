...
public struct Quote: Decodable {
    ...
    public var splitCoeff: String?
    
    public init(open: String? = nil, high: String? = nil, low: String? = nil, close: String? = nil, adjusted: String? = nil, volume: String? = nil, dividend: String? = nil, splitCoeff: String? = nil) {
        self.open = open
        self.high = high
        self.low = low
        self.close = close
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.splitCoeff = try container.decodeIfPresent(String.self, forKey: .splitCoeff)
    }
}
